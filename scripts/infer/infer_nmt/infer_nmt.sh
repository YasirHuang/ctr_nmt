#!/usr/bin/env bash
# e.g.: ./infer_nmt.sh 0 multi30k multi30k-test2016 1234 0
#       ./infer_nmt.sh 0 d d 1234 0
# 1: gpu_id
# 2: train data
# 3: test data
# 4: random_seed
...
#OUT_DIR_BASE=${PROJECT_DIR}/experiment/models/nmt
#OUT_DIR_BASE=${PROJECT_DIR}/experiment/models/nmt.en2fr
OUT_DIR_BASE=${PROJECT_DIR}/experiment/models/nmt.en2cs
OUT_DIR=${OUT_DIR_BASE}/calixto_baseline.1layerlstm.${SUFFIX}

mkdir -p ${PROJECT_DIR}/experiment/records/${OUT_DIR_BASE##*/}
#OUT_DIR=${OUT_DIR}/calixto_baseline.1layerlstm.torchtext.0.3drop.nobpe.initdec.r${RANDOM_SEED}.${SUFFIX}
cp $0 ${OUT_DIR}/
