#!/usr/bin/env bash
# e.g.: ./train_transformer.sh 0 multi30k multi30k-test2016 1234 0
#       ./train_transformer.sh 0 d d 1234 0
# 1: gpu_id
# 2: train data
# 3: test data
# 4: random_seed
...
#OUT_DIR=${PROJECT_DIR}/experiment/models/transformer
OUT_DIR=${PROJECT_DIR}/experiment/models/transformer.en2cs
